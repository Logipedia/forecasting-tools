...
class GptO1(OpenAiTextToTextModel):
    ...
    def __init__(self, *args: Any, temperature: float = 1, system_prompt: str | None = None, **kwargs: Any):
        assert system_prompt is None, "GptO1Preview does not support system prompts"
        assert temperature == 1, f"GptO1Preview must have temperature 1, but {temperature} was given."
